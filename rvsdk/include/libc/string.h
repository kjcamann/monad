...
inline void *memcpy(void *__restrict dst, void const *__restrict src, size_t n)
{
    return (void *)rv64_syscall3(
        (long)dst, (long)src, (long)n, RVI_ECALL_C_MEMCPY);
}

inline void *memmove(void *dst, void const *src, size_t n)
{
    return (void *)rv64_syscall3(
        (long)dst, (long)src, (long)n, RVI_ECALL_C_MEMMOVE);
}

inline void *memset(void *dst, int c, size_t n)
{
    return (void *)rv64_syscall3(
        (long)dst, (long)c, (long)n, RVI_ECALL_C_MEMSET);
}

inline int memcmp(void const *s1, void const *s2, size_t n)
{
    return (int)rv64_syscall3((long)s1, (long)s2, (long)n, RVI_ECALL_C_MEMCMP);
}

inline void *memchr(void const *s, int c, size_t n)
{
    return (void *)rv64_syscall3((long)s, (long)c, (long)n, RVI_ECALL_C_MEMCHR);
}
...
{
    return (char *)rv64_syscall2((long)dst, (long)src, RVI_ECALL_C_STRCPY);
}

inline char *strncpy(char *__restrict dst, char const *__restrict src, size_t n)
{
    return (char *)rv64_syscall3(
        (long)dst, (long)src, (long)n, RVI_ECALL_C_STRNCPY);
}
...
{
    return (char *)rv64_syscall2((long)s, (long)c, RVI_ECALL_C_STRCHR);
}

inline char *strrchr(char const *s, int c)
{
    return (char *)rv64_syscall2((long)s, (long)c, RVI_ECALL_C_STRRCHR);
}
...
{
    return (size_t)rv64_syscall1((long)s, RVI_ECALL_C_STRLEN);
}

inline char *strerror(int rc)
{
    return (char *)rv64_syscall1((long)rc, RVI_ECALL_C_STRERROR);
}
...
{
    return (char *)rv64_syscall2((long)dst, (long)src, RVI_ECALL_C_STPCPY);
}

inline char *stpncpy(char *__restrict dst, char const *__restrict src, size_t n)
{
    return (char *)rv64_syscall3(
        (long)dst, (long)src, (long)n, RVI_ECALL_C_STPNCPY);
}
...
inline size_t strlcpy(char *dst, char const *src, size_t n)
{
    return (size_t)rv64_syscall3(
        (long)dst, (long)src, (long)n, RVI_ECALL_C_STRLCPY);
}
