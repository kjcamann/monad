...
inline struct rv64_syscall_rpair rv64_syscall0_r2(long const n)
{
...
inline long rv64_syscall0(long const n)
{
    register long a0 __asm__("a0");
    register long t0 __asm__("t0") = n;
...
inline long rv64_syscall1(long const a, long const n)
{
...
inline long rv64_syscall2(long const a, long const b, long const n)
{
    register long a0 __asm__("a0") = a;
