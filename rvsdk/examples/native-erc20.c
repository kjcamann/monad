...
MRV_STORAGE_ZINIT monad_abi_t g_mrv_default_param_abi;
MRV_STORAGE_ZINIT struct mrv_erc20 g_demo_token;
...
MRV_EXPORT struct monad_bv init_contract(struct monad_bv const init_calldata)
{
    ...
    // Initialize our ERC20 contract's storage variables from the data in
    // `init_args`
