...
public:
    ...
    virtual monad_event_content_type
    get_content_type(EventSourceSpec const &) const = 0;
...
public:
    ...
    get_content_type(EventSourceSpec const &) const override
    {
        return event_ring_.header->content_type;
    }
    ...
    void init_iterator(EventIterator *, EventSourceSpec const &) const override;
...
public:
    ...
    get_content_type(EventSourceSpec const &) const override
    {
        return MONAD_EVENT_CONTENT_TYPE_EXEC;
    }
    ...
    monad_bcap_block_archive const *get_block_archive() const
    {
        return archive_;
    }
...
private:
    std::filesystem::path origin_path_;
    int archive_fd_;
    monad_bcap_block_archive *archive_;
};
