...
constexpr uint64_t MONAD_BCAP_FILES_PER_SUBDIR = 10'000;
...
int monad_bcap_block_archive_get_dirfd(struct monad_bcap_block_archive const *);
...
int monad_bcap_block_archive_open_block_fd(
    struct monad_bcap_block_archive const *, uint64_t block_number,
    int open_flags, mode_t dir_create_mode, mode_t file_create_mode,
...
int monad_bcap_block_archive_open_block_writer(
    struct monad_bcap_block_archive *, uint64_t block_number,
    mode_t dir_create_mode, mode_t file_create_mode, char *path_buf,
    size_t path_buf_size, int *fd_out, struct monad_evcap_writer **,
