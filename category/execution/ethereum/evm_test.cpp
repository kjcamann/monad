...
TYPED_TEST(TraitsTest, static_precompile_execution)
{
    ...
    evmc_message const m{
        .kind = EVMC_CALL,
        .gas = 400,
        .recipient = to_evmc(code_address),
        .sender = to_evmc(from),
...
TYPED_TEST(TraitsTest, create_op_max_initcode_size)
{
    ...
    if constexpr (
        ...
        evmc_message m{
            .kind = EVMC_CALL,
            .gas = 1'000'000,
            .recipient = to_evmc(good_code_address),
            .sender = to_evmc(from),
            .code_address = to_evmc(good_code_address),
            .memory_handle = msg_memory.get(),
            .memory = msg_memory.get(),
            .memory_capacity = vm.message_memory_capacity()};
    ...
    if constexpr (
        ...
        evmc_message m{
            .kind = EVMC_CALL,
            .gas = 1'000'000,
            .recipient = to_evmc(bad_code_address),
            .sender = to_evmc(from),
            .code_address = to_evmc(bad_code_address),
            .memory_handle = msg_memory.get(),
            .memory = msg_memory.get(),
            .memory_capacity = vm.message_memory_capacity()};
...
TYPED_TEST(TraitsTest, create_inside_delegated_call)
{
    ...
    evmc_message const m{
        ...
        .gas = 1'000'000,
        .recipient = to_evmc(eoa),
        .sender = to_evmc(from),
        .code_address = to_evmc(delegated),
        .memory_handle = msg_memory.get(),
        .memory = msg_memory.get(),
        .memory_capacity = vm.message_memory_capacity(),
    };
...
TYPED_TEST(TraitsTest, nested_call_to_delegated_precompile)
{
    ...
    evmc_message const m{
        .kind = EVMC_CALL,
        .gas = 1'000'000,
        .recipient = to_evmc(contract),
        .sender = to_evmc(from),
        .code_address = to_evmc(contract),
        .memory_handle = msg_memory.get(),
        .memory = msg_memory.get(),
        .memory_capacity = vm.message_memory_capacity(),
    };
