...
typedef int(monad_evsrc_iter_set_seqno_fn_t)(void *, uint64_t);

MONAD_SDK_EVSRC_ITER_DECL(int, monad_evsrc_iter_set_seqno, uint64_t)
...
typedef struct monad_evsrc_any_iter const *(monad_evsrc_const_any_iter_from_fn_t)(void *);
