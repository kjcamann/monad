                ...
                let account_accesses = match access_context {
                    ...
                    ffi::MONAD_ACCT_ACCESS_TRANSACTION => {
                        ...
                        let txn_ref = state
                            ...
                            .as_mut()
                            .expect(
                                "ExecutedBlockBuilder AccountAccessListHeader txn_index populated from preceding TxnHeaderStart",
                            );
                ...
                let account_accesses = match access_context {
                    ...
                    ffi::MONAD_ACCT_ACCESS_TRANSACTION => {
                        ...
                        let txn_ref = state
                            ...
                            .as_mut()
                            .expect(
                                "ExecutedBlockBuilder AccountAccess txn_index populated from preceding TxnHeaderStart",
                            );
                ...
                let account_accesses = match access_context {
                    ...
                    ffi::MONAD_ACCT_ACCESS_TRANSACTION => {
                        ...
                        let txn_ref = state
                            ...
                            .as_mut()
                            .expect(
                                "ExecutedBlockBuilder StorageAccess txn_index populated from preceding TxnHeaderStart",
                            );
